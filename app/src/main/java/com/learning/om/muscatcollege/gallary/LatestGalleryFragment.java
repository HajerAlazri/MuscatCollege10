 ...
 * {@link LatestGalleryFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link LatestGalleryFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LatestGalleryFragment extends Fragment implements RecyclerAdapter.onItemClick {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private String[] name={"Ali","Ammar","Hatim","Ahmed","Alaa","Suliman"};
    private String[] specialization={"MCA","IT","ENG","AC","MBA","ELC"};
    private String[] address={"Ruwi","Sohar","Seeb","Nizwa","Alkouhd","Sohar"};
     ...
     * @return A new instance of fragment LatestGalleryFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LatestGalleryFragment newInstance(String param1, String param2) {
        LatestGalleryFragment fragment = new LatestGalleryFragment();
    ...
    //Data containers that passes data to the adapter
